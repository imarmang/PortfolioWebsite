...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 h-full w-[75px] bg-[#181818] z-50 flex flex-col items-center justify-center max-[900px]:hidden">
        {/* Logo and name */}
        <Link
      ...
      <div className="hidden max-[900px]:flex fixed top-0 left-0 w-full h-[60px] bg-[#181818] z-40 items-center justify-between px-4">
